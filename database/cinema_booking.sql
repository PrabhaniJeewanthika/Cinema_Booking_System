...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2025 at 12:04 PM
...
(1, 1, 1, 'A1', '2025-08-09 19:52:00'),
(2, 1, 1, 'E12', '2025-08-09 19:52:19'),
(3, 1, 1, 'A11', '2025-08-10 03:32:21');
...
INSERT INTO `movies` (`id`, `title`, `show_time`, `created_at`) VALUES
(1, 'Sample Movie', '2025-08-10 01:21:17', '2025-08-09 19:51:17');
...
INSERT INTO `registeredusers` (`id`, `name`, `email`, `contact`, `username`, `password`) VALUES
(1, 'Hansanath', 'hansa1234@gmail.com', '0987654321', 'wefaw', '$2y$10$DeisM4vfXJD6FWsWODLjrOwJhE7FIifrk/GWnQ/URheOVssu5CJKy');
...
(1, 'Test User', 'test@local', 'x', '2025-08-09 19:51:17');
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `fk_b_movie` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE,
